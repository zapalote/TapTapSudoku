        ...
        <View style={[styles.modalContainer, layoutStyle]} >
          ...
          <View style={styles.textBlock}>
            <Touchable disabled={disabled} onPress={() => {this.props.onResume();}} >
              <Image style={[styles.buttonMenu, disabled && styles.disabled]} source={require('../assets/images/continue.png')} />
            </Touchable>
            <Touchable disabled={disabled} onPress={() => {this.props.onRestart();}} >
              <Image style={[styles.buttonMenu, disabled && styles.disabled]} source={require('../assets/images/restart.png')} />
            </Touchable>
            <Touchable onPress={() => {this.props.onCreate();}} >
              <Image style={styles.buttonMenu} source={require('../assets/images/newgame.png')} />
            </Touchable>
          </View>
        </View>
        <View style={styles.footer}>
          <Touchable style={styles.button} onPress={() => {this.props.onAbout();}} >
            <Image style={styles.buttonIcon} source={require('../assets/images/about.png')} />
          </Touchable>
          <Touchable style={styles.button} onPress={() => {this.props.onDoc();}} >
            <Image style={styles.buttonIcon} source={require('../assets/images/help.png')} />
          </Touchable>
          <Touchable style={styles.button} onPress={() => {this.props.onSettings();}} >
            <Image style={styles.buttonIcon} source={require('../assets/images/settings.png')} />
          </Touchable>
          <Touchable style={styles.button} onPress={() => {this.props.onRate();}} >
            <Image style={styles.buttonIcon} source={require('../assets/images/rate.png')} />
          </Touchable>
        </View>
      </View>
    );
